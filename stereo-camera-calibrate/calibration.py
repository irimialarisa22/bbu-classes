...
if __name__ == '__main__':
    image_path_left = glob.glob("img_for_calib/left/*.jpg")
    image_path_right = glob.glob("img_for_calib/right/*.jpg")

    mtx_l, dst_l, mtx_r, dst_r = calibrate_cameras_for_intrinsic_parameters(image_path_left, image_path_right)
    e, f, r, t, r1, r2, p1, p2, q = stereo_calibrate(mtx_l, dst_l, mtx_r, dst_r, image_path_left, image_path_right)
